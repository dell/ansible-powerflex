...
- "This module is CREATION-ONLY. Ongoing management of the resulting
  ...
  of the C(dellemc.powerflex.volume_v2) module, following the PowerFlex
...
LOG = utils.get_logger("thin_clone_v2")


@powerflex_compatibility(min_ver='5.0')
class PowerFlexThinCloneV2(PowerFlexBase):
...
def get_powerflex_thin_clone_parameters():
    """Parameters required for the thin_clone_v2 module"""
    return dict(
