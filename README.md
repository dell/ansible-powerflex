...
|---------------------|-----------------------|-------|--------------------|--------------------------|
| v2.6.0 |3.6 <br> 4.5 <br> 4.6 <br> APEX Block Storage for Mircrosoft Azure <br> APEX Block Storage for AWS | 1.14.0 | 3.9.x <br> 3.10.x <br> 3.11.x <br> 3.12.x | <br> 2.16 <br> 2.17 <br> 2.18 |
