...
|---------------------|-----------------------|-------|--------------------|--------------------------|
| v3.1.0 |4.8 <br> 4.6 <br> 5.0 <br> 5.1 Gen2 (Core 5.1) <br> APEX Block Storage for Mircrosoft Azure <br> APEX Block Storage for AWS | 2.0.0 | 3.13.x <br> 3.14.x | 2.18 <br> 2.19 <br> 2.20 |
