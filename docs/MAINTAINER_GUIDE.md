...
* Lead by example
* Follow the [Code of Conduct](https://github.com/dell/ansible-powerflex/blob/1.4.0/CODE_OF_CONDUCT.md) and the guidelines in the [Contributing](https://github.com/dell/ansible-powerflex/blob/1.4.0/CONTRIBUTING.md) and [Committer](https://github.com/dell/ansible-powerflex/blob/1.4.0/COMMITTER_GUIDE.md) guides
