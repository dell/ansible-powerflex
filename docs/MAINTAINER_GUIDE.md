...
* Lead by example
* Follow the [Code of Conduct](https://github.com/dell/ansible-powerflex/blob/1.8.0/CODE_OF_CONDUCT.md) and the guidelines in the [Contributing](https://github.com/dell/ansible-powerflex/blob/1.8.0/CONTRIBUTING.md) and [Committer](https://github.com/dell/ansible-powerflex/blob/1.8.0/COMMITTER_GUIDE.md) guides
